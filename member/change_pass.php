...
$get_customer = "select member_pass from members where member_email='$member_session'";
?>
...
if (isset($_POST['submit'])) {
    ...
    $sel_c_old_pass = "select * from members where member_pass='$c_old_pass'";
    ...
    $update_c_pass = "update members set member_pass='$c_new_pass' where member_email='$c_email'";
